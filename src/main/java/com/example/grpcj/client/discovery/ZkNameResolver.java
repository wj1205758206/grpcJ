package com.example.grpcj.client.discovery;
...
public class ZkNameResolver extends NameResolver implements Watcher {
    ...
    public void start(Listener listener) {
        ...
        try {
            ...
            logger.error("add servers to listener exception:{}", e.getMessage());
        }
    ...
    public void process(WatchedEvent watchedEvent) {
        if (watchedEvent.getType() == Event.EventType.None) {
            ...
            try {
                ...
                addServersToListener(children); // 每次监听到变化后都要重新更新servers
